...
public class MapsActivity extends Menu implements
   ...
   // private ArrayList<Service_Provider> vendorList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("ServiceCategory Providers");
...
//        pd.setMessage("Finding " + service_name + " ServiceCategory Providers");
...
//                                    misc.showToast("No ServiceCategory Provider of : " + service_name + " Found");
//                                    pd.dismiss();
//                                    return;
//                                }
//                                vendorList.clear();
