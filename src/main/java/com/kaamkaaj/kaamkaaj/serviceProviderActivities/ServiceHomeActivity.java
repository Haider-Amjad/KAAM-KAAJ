...
import com.kaamkaaj.kaamkaaj.LoginActivity;
...
public class ServiceHomeActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.service_profile) {
            Intent profile = new Intent(this, com.kaamkaaj.kaamkaaj.serviceProviderActivities.ServiceProfileActivity.class);
...
//            Intent update = new Intent(this, com.mazdur.mazdur.serviceProviderActivities.UpdateServicesActivity.class);
...
//        }
            ...
            Intent updatePassword = new Intent(this, com.kaamkaaj.kaamkaaj.serviceProviderActivities.SerivceUpdatePasswordActivity.class);
            updatePassword.putExtra("password", password);
            startActivity(updatePassword);
            finish();
        }
        else if (id == R.id.reports) {
            Intent logout = new Intent(this, PaymentActivity.class);
            startActivity(logout);
            finish();
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
