...
import com.kaamkaaj.kaamkaaj.Adapters.VendorServiceAdapter;
...
//        serviceRecycler = findViewById(R.id.vendor_services);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AllProvidersActivity.this, com.kaamkaaj.kaamkaaj.serviceProviderActivities.ServiceHomeActivity.class);
