...
public class ProfileVendorActivity extends AppCompatActivity {
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions
                        (ProfileVendorActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_CODE);
            }
        });
                    ...
                    public void onCompleted(Exception e, Response<String> result) {
                        ...
                        try{
                            ...
                            if (!status) {
                                ...
                                Intent intent = new Intent(ProfileVendorActivity.this, AllProvidersActivity.class);
                                startActivity(intent);
                                finish();
                            }
