...
public class RegisteredServicesAdapter extends RecyclerView.Adapter<RegisteredServicesAdapter.RegisteredServiceViewHolder> {
    ...
    private ArrayList<com.kaamkaaj.kaamkaaj.Models.Service> serviceListModel = new ArrayList<>();
    private ArrayList<com.kaamkaaj.kaamkaaj.Models.Service> tempServiceListModel = new ArrayList<>();
