...
import com.kaamkaaj.kaamkaaj.Models.Vendor;
...
public class MapsActivity extends FragmentActivity implements
                ...
                .setCallback(new FutureCallback<Response<String>>() {
                    ...
                    public void onCompleted(Exception e, Response<String> result) {
                        if(e != null) {
                            ...
                            startActivity(new Intent(getApplicationContext(), com.kaamkaaj.kaamkaaj.JobHistoryActivity.class));
                            finish();
                        }
                    }
                });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, com.kaamkaaj.kaamkaaj.AllServiceActivity.class);
