...
//                Intent intent = new Intent(LoginActivity.this, com.kaamkaaj.kaamkaaj.AllServiceActivity.class);
//                startActivity(intent);
//                finish();
//            }
//            if(userRole.equalsIgnoreCase("vendor")) {
//                Intent intent = ne w Intent(LoginActivity.this, ServiceHomeActivity.class);
//                startActivity(intent);
//                finish();
//            }
//        }
//    }
    ...
    public void onClick(View v) {
        if(v.getId() == register.getId()){
            Intent intent = new Intent(this, com.kaamkaaj.kaamkaaj.RegisterAsActivity.class);
            startActivity(intent);
            finish();
        }
        if(v.getId() == forgot.getId()) {
            Intent intent = new Intent(this, com.kaamkaaj.kaamkaaj.ResetPasswordActivity.class);
            startActivity(intent);
            finish();
        }
        if(v.getId() == login.getId()){
            Intent intent = new Intent(this, com.kaamkaaj.kaamkaaj.MainActivity.class);
            startActivity(intent);
            finish();
//            String email = user_email.getText().toString().trim();
//            String password = user_password.getText().toString().trim();
//            if((email.equals("admin@mazdur.com")) && (password.equals("admin@@@"))) {
...
//                                    sharedPref.createLoginSession(id, role, userOnline);
//                                    pd.dismiss();
//                                    Intent intent = new Intent(LoginActivity.this, com.kaamkaaj.kaamkaaj.AllServiceActivity.class);
//                                    startActivity(intent);
//                                    finish();
